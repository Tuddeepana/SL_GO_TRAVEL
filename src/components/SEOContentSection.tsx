      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center md:text-left">
          ...
          <div className="space-y-4 text-muted-foreground leading-relaxed">
            ...
            <p>
              Whether you need an airport pickup, hotel transfer, safari jeep booking or full Sri Lanka tour transport, 
              our experienced drivers ensure a comfortable and reliable journey.
            </p>
          </div>
        </div>
      </div>
